        ...
        <>
            ...
            <div class="container col-xxl-8 px-4 mt-3">
                <div class="row flex-lg-row-reverse align-items-center justify-content-center me-5 ms-0">
                    <div class="col-lg-6">
                        <h1 class="display-1 mb-3">Send money feely easily</h1>
                        <p class="lead" style={{ color: "#B5BCC8" }}>Welcome to the new finance world of MailCash where you can send money securely and freely to emails</p>
